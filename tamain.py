...
class HomePage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        ladec1 = tk.Label(self, justify= CENTER, font=("Berlin Sans FB",25), fg="#3cf22c", bg ="black",text ="x +\n- /") 
        ladec1.place(anchor=CENTER,x=165,y=140)
        ladec2 = tk.Label(self, justify= CENTER, font=("Berlin Sans FB",25), fg="#3cf22c", bg ="black",text ="% 1\n0 :") 
        ladec2.place(anchor=CENTER,x=835,y=140)
        ladec3 = tk.Label(self, justify= CENTER, font=("Berlin Sans FB",25), fg="#3cf22c", bg ="black",text ="> <\n= !") 
        ladec3.place(anchor=CENTER,x=165,y=430)
        ladec4 = tk.Label(self, justify= CENTER, font=("Berlin Sans FB",25), fg="#3cf22c", bg ="black",text ="# E\n*  8") 
        ladec4.place(anchor=CENTER,x=835,y=430)
        ...
        def clickb2():
            ...
            for i in range(pnj+1):
                ...
                lbscore = tk.Label(fboard,font=("Berlin Sans FB",18,),text=f"{lpscore}",fg="#f5dd9d",bg="#290345" )
                lbscore.place(anchor=NW,x=10,y=27)
        ...
        button2 = tk.Button(self, font = ("Berlin Sans FB",15), fg="#80ffff", bg ="#08024d", relief=FLAT, width=12,
                            text ="Leaderboard\nScore", justify=CENTER,
                            command = lambda : [ clickb2()])
        button2.place(anchor=W,x=100,y=250)        
                
        button3 = tk.Button(self,font = ("Berlin Sans FB",15), fg="#e4d5f2", bg ="#290345", relief=FLAT, width=12,
                            text ="How To\nPlay", justify=CENTER,
...
listLB = [["Hyun",9425,8,3,4.83],["OXOB30",14003,10,1,5.09],["GildGuy",15023,11,2,4.63]]
...
class PlayPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        def timelimit():
            ...
            while wt >= 0:
                if wt > 10:
                    ltimer.config(text=f"{wt} second", fg="#ff7003")
                else:
                    ltimer.config(text=f"{wt} second", fg="red")
                    ltm.config(bg="red")
                time.sleep(1)
                wt -= 1
            ...
            def cksch (*args):
                if (len(strname.get()) > 7 or len(strname.get()) == 0):
        ...
        ltm = tk.Label(self, justify= CENTER, font = ("Berlin Sans FB",14),fg="#f7dda1",bg="#fc6203",
                         text ="Timer:")   
        ltm.place(anchor = SE, x = 60, y = 145)
        ltimer = tk.Label(self, justify= CENTER, font = ("Berlin Sans FB",14),bg="#f7dda1", fg ="#08024d",width=9,
                         text ="60 second")   
        ltimer.place(anchor = SW, x = 60, y = 145)
